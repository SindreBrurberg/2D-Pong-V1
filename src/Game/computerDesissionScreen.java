...
public class computerDesissionScreen extends Screen {
    ...
    public computerDesissionScreen(ScreenFactory screenFactory) {
        super(screenFactory);
        string = new string(50, 15, Width, Hight, "Select Game.Computer Difficulity!");
        butten = new butten(50, 225, Width, Hight, "Easy Difficulity!") {
            @Override
            public void update() {
                if (isActive())
                    Reference.speedP2 = Reference.speedSlowComputer;
            }
        };
        butten2 = new butten(50, 425, Width, Hight, "Medium Difficulity!") {
            ...
            public void update() {
                if (isActive())
                    Reference.speedP2 = Reference.speedMediumComputer;
            }
        };
        butten3 = new butten(50, 625, Width, Hight, "Hard Difficulity!") {
            ...
            public void update() {
                if (isActive())
                    Reference.speedP2 = Reference.speedFastComputer;
            }
        };
    }
